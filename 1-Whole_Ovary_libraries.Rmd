---
title: "Whole Ovary Dataset Analysis"
output:
  html_document:
    df_print: paged
    toc: true
...
#export PATH="/home/ysland/miniconda3/envs/newEnv/bin/:$PATH"
#export RSTUDIO_WHICH_R=/home/ysland/miniconda3/envs/newEnv/bin/R
...
```{r}
load( file="data/VST_WO.Rda")
Meta_BioSample_3<-read.csv(file="data/Meta_BioSample_3.csv", sep=",")
rownames(Meta_BioSample_3)<-Meta_BioSample_3$BioSample_GY
Counts_metadata_long<-readr::read_tsv(file="data/WholeOvary_metadata_long.tsv")
Counts_wide<-read.csv(file="data/WholeOvary_table_counts_wide.tsv",sep="\t")
```
